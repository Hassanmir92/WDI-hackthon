...
class FlavoursControllerTest < ActionController::TestCase
  ...
  test "should create flavour" do
    assert_difference('Flavour.count') do
      post :create, flavour: { cheekyness: @flavour.cheekyness, mood: @flavour.mood, name: @flavour.name, personality: @flavour.personality, scenariotube: @flavour.scenariotube, transport: @flavour.transport }
    end
  ...
  test "should update flavour" do
    patch :update, id: @flavour, flavour: { cheekyness: @flavour.cheekyness, mood: @flavour.mood, name: @flavour.name, personality: @flavour.personality, scenariotube: @flavour.scenariotube, transport: @flavour.transport }
    assert_redirected_to flavour_path(assigns(:flavour))
  end
